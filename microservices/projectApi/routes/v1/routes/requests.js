...
router.get('/permissions/:requestName', function(req, res, next) {
});
...
router.put('/admin/project', function(req, res, next) {
});

// remove project
router.delete('/admin/project', function(req, res, next) {
});

// remove permission from project
router.delete('/admin/permission', function(req, res, next) {
});
